  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        ...
        {/* Social Links */}
        <div className="flex justify-center gap-6 slide-in-up" style={{ animationDelay: '0.6s' }}>
          <a 
            href="https://linkedin.com/in/nishantkumarakadatascyther" 
            className="w-12 h-12 rounded-full bg-muted/50 flex items-center justify-center hover:bg-gradient-purple/20 transition-all duration-300 hover:scale-110"
            target="_blank"
